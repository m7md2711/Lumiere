  ...
  return (
    <div className="min-h-screen bg-slate-50 lg:flex">
      ...
      <aside className="no-print hidden w-60 shrink-0 border-e border-slate-200 bg-white lg:block">
        <div className="sticky top-0 flex h-screen flex-col p-4">
          <Link href="/admin/cases" className="mb-6 flex items-center gap-2.5 px-2 pt-2">
            <span className="text-clinic-700"><LogoMark size={32} /></span>
            <span className="text-sm font-semibold text-clinic-800">Lumiere Feedback</span>
          </Link>
      ...
      <div className="flex-1 pb-20 lg:pb-0">
        {/* Mobile top bar */}
        <header className="no-print sticky top-0 z-20 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 lg:hidden">
          <Link href="/admin/cases" className="flex items-center gap-2">
            <span className="text-clinic-700"><LogoMark size={26} /></span>
            <span className="text-sm font-semibold text-clinic-800">Lumiere Feedback</span>
          </Link>
          <form action={signOut}>
      ...
      {/* Mobile bottom tabs */}
      <nav className="no-print fixed inset-x-0 bottom-0 z-20 border-t border-slate-200 bg-white lg:hidden">
